...
class TickerComparison:
    ...
    def _set_company_data(self):
        ...
        self._ticker_one_data = MetaDataComp(
            ...
            close=ticker_one_instance.time_series[Finance.close][0],
        ...
        self._ticker_two_data = MetaDataComp(
            ...
            close=ticker_two_instance.time_series[Finance.close][0],
    ...
    def get_difference(self) -> dict[str, float]:
        ...
        difference = {
            ...
            Finance.close: abs(round(self._ticker1_data.close - self._ticker2_data.close, 2)),
